...
def _get_hf_dataset_ragged(
    ...
    def _tokenize(batch: Dict):
        ...
        ids = tok(batch["text"], add_special_tokens=False, return_attention_mask=False)["input_ids"]
...
class FASTADataset(Dataset):
    ...
    def __getitem__(self, idx: int) -> Dict[str, List[int]]:
        seq = self._seqs[idx]
        ids = self.tok(seq, add_special_tokens=False, return_attention_mask=False)["input_ids"]
